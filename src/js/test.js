...
function headerProductKeyup(obj) {
  ...
  if (val) {
    searchResults.forEach(function (location) {
      ...
      singleProductAutoCompleteList += `<li> <a href="#" onClick="javascript:headerShortcodeProducts(this);"
      data-distance="${distance}" data-depo="${location['Depo']}" data-suburb="${location['Suburb']}">
      ${location['Suburb']}, ${location['Postcode']},
      ${distance}, ${location['Depo']}</a> </li>`;
...
function singleProductKeyup(obj) {
  ...
  if (val) {
    searchResults.forEach(function (location) {
      ...
      singleProductAutoCompleteList += `<li> <a href="${currentUrl}?attribute_depo=${location['Depo']}&attribute_distance=${Distance}">${location['Suburb']}, ${location['Postcode']}</a> </li>`;
    });
...
// Swiper.js code for home page carsouel
