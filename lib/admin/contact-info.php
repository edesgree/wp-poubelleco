...
/**
 *
 * Section in admin/settings/contact info
 * Add contact info about the company
 *
 */
...
{ ?>
    ...
    <input type="tel" name="support_phone" placeholder="Enter phone number"
        value="<?php echo get_option('support_phone'); ?>" size="35">
...
{ ?>
    ...
    <input type="text" name="support_address" placeholder="Enter address"
        value="<?php echo get_option('support_address'); ?>" size="35">
...
{ ?>
    ...
    <input type="email" name="support_email" placeholder="Enter email address"
        value="<?php echo get_option('support_email'); ?>" size="35">
...
function display_custom_info_fields()
{
    ...
    add_settings_field("support_address", "Support address.", "display_support_address_element", "theme-options", "section");
