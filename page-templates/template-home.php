        ...
        <div class="container">
            ...
            <div class="home-products">
                <div class="home-product row">
                    <a href="" class="btn-get-a-quote btn btn-secondary text-capitalize">Get a quote for this
                        skip bin</a>
                    <div class="col-lg-4 col-sm-6">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/src/assets/images/products/skipbin-5m3.jpg"
                            class="img-fluid " alt="bin ">
                    </div>
                    <div class="col-lg-4 col-sm-6">
                        <h5>4 Cubic Metre Skip</h5>
                        <ul class="list-specs">
